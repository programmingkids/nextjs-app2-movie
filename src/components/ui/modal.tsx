        ...
        <div className="relative bg-white rounded-lg shadow-sm">
          ...
          <div className="p-4 md:p-5 text-center">
            ...
            <button
              ...
              type="button"
              onClick={onClose}
              className="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-10 py-2.5 text-center"
            >
              {okButtonText}
            </button>
          </div>
