...
export const UserOptionalDefaultsWithRelationsSchema: z.ZodType<UserOptionalDefaultsWithRelations> =
  UserOptionalDefaultsSchema.merge(
    z.object({
      playlist: z
        .lazy(() => PlaylistOptionalDefaultsWithRelationsSchema)
        .array(),
    }),
  );
...
export const PlaylistOptionalDefaultsSchema = PlaylistSchema.merge(
  z.object({
...
export type PlaylistOptionalDefaults = z.infer<
  typeof PlaylistOptionalDefaultsSchema
>;
...
export type PlaylistWithRelations = z.infer<typeof PlaylistSchema> &
  PlaylistRelations;

export const PlaylistWithRelationsSchema: z.ZodType<PlaylistWithRelations> =
  PlaylistSchema.merge(
    z.object({
...
export type PlaylistOptionalDefaultsWithRelations = z.infer<
  typeof PlaylistOptionalDefaultsSchema
> &
  PlaylistOptionalDefaultsRelations;

export const PlaylistOptionalDefaultsWithRelationsSchema: z.ZodType<PlaylistOptionalDefaultsWithRelations> =
  PlaylistOptionalDefaultsSchema.merge(
    z.object({
...
export type PlaylistPartialWithRelations = z.infer<
  typeof PlaylistPartialSchema
> &
  PlaylistPartialRelations;

export const PlaylistPartialWithRelationsSchema: z.ZodType<PlaylistPartialWithRelations> =
  PlaylistPartialSchema.merge(
    z.object({
...
export type PlaylistOptionalDefaultsWithPartialRelations = z.infer<
  typeof PlaylistOptionalDefaultsSchema
> &
  PlaylistPartialRelations;

export const PlaylistOptionalDefaultsWithPartialRelationsSchema: z.ZodType<PlaylistOptionalDefaultsWithPartialRelations> =
  PlaylistOptionalDefaultsSchema.merge(
    z
      .object({
        video: z.lazy(() => VideoPartialWithRelationsSchema).array(),
...
export type PlaylistWithPartialRelations = z.infer<typeof PlaylistSchema> &
  PlaylistPartialRelations;

export const PlaylistWithPartialRelationsSchema: z.ZodType<PlaylistWithPartialRelations> =
  PlaylistSchema.merge(
    z
      .object({
        video: z.lazy(() => VideoPartialWithRelationsSchema).array(),
...
export const VideoOptionalDefaultsSchema = VideoSchema.merge(
  z.object({
    id: z.number().int().optional(),
    createdAt: z.coerce.date().optional(),
    modifiedAt: z.coerce.date().optional(),
...
export type VideoOptionalDefaultsWithRelations = z.infer<
  typeof VideoOptionalDefaultsSchema
> &
  VideoOptionalDefaultsRelations;

export const VideoOptionalDefaultsWithRelationsSchema: z.ZodType<VideoOptionalDefaultsWithRelations> =
  VideoOptionalDefaultsSchema.merge(
    z.object({
...
export type VideoPartialWithRelations = z.infer<typeof VideoPartialSchema> &
  VideoPartialRelations;

export const VideoPartialWithRelationsSchema: z.ZodType<VideoPartialWithRelations> =
  VideoPartialSchema.merge(
    z.object({
      playlist: z.lazy(() => PlaylistPartialWithRelationsSchema),
    }),
  ).partial();

export type VideoOptionalDefaultsWithPartialRelations = z.infer<
  typeof VideoOptionalDefaultsSchema
> &
  VideoPartialRelations;

export const VideoOptionalDefaultsWithPartialRelationsSchema: z.ZodType<VideoOptionalDefaultsWithPartialRelations> =
  VideoOptionalDefaultsSchema.merge(
    z
      .object({
        playlist: z.lazy(() => PlaylistPartialWithRelationsSchema),
...
export type VideoWithPartialRelations = z.infer<typeof VideoSchema> &
  VideoPartialRelations;

export const VideoWithPartialRelationsSchema: z.ZodType<VideoWithPartialRelations> =
  VideoSchema.merge(
    z
      .object({
        playlist: z.lazy(() => PlaylistPartialWithRelationsSchema),
